...
$SPARK_HOME/bin/spark-submit --master spark://nashville:30860 --class IdealPR --supervise target/scala-2.11/sparkpagerank_2.11-1.0.jar $INPUT $TITLE $OUTPUT $TAXATION
